...
int m[1100000];
int s[1100000];
//arrs stores sum val of prev number from which number of mod value j and sum i is reached
//arrs stores previous mod value to read number sum i and mod val j
int main()
{
	int t;
	memset(T,-1,sizeof(T));	
