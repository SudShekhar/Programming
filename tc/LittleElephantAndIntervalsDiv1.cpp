...
//I manually run through each interval and allot colors to them
// This works because the problem has easy constraints. M<=1000 and number of paint queries <=50
